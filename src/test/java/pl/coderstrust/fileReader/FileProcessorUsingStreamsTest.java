...
public class FileProcessorUsingStreamsTest {
  ...
  private FileProcessorUsingStreams fileProcessor = new FileProcessorUsingStreams();

  @Test
  public void readLinesFromFileWhenNoFileExceptionThrown() throws IOException, URISyntaxException {
  ...
  @Test
  public void readLinesFromFileShouldReturnStringList() throws IOException, URISyntaxException {
  ...
  public void writeLinesToFileUsingFileShouldReturnFile() throws IOException {
    ...
    fileProcessor.writeLinesToFile(source, WRITE_LINES_PATH);
