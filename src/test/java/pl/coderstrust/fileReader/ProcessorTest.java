...
public class ProcessorTest {
  ...
  @Mock NumberProcessor numbersProcessor;

  @Mock FileProcessor fileProcessor;

  @InjectMocks Processor processor;
  ...
  public void process() throws IOException, URISyntaxException {
    ...
    doNothing().when(fileProcessor).writeLinesToFileUsingFile(Arrays.asList(OUTPUT), OUTPUT_FILE);
    ...
    verify(fileProcessor).writeLinesToFileUsingFile(Arrays.asList(OUTPUT), OUTPUT_FILE);
  }
  ...
  public void processArgumentValuesVerificationWithArgumentCapture()
    ...
    verify(fileProcessor)
        .writeLinesToFileUsingFile(argumentList.capture(), argumentString.capture());
