...
import static pl.coderstrust.multiplication.MultiplicationTable.createIntArray;
import static pl.coderstrust.multiplication.MultiplicationTable.createStringTable;
...
public class MultiplicationTableTest {
  ...
  public void shouldReturnMultiplicationTableWithStrings(int size, String[][] expectedResult) {
    // When
    int[][] intTable = createIntArray(size);
